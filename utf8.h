...
#define NATIVESKIP(uv) OFFUNISKIP(NATIVE_TO_UNI(uv))
 ...
 * it means existing code continues to work.  For precision, use NATIVESKIP and
 * OFFUNISKIP */
#define UNISKIP(uv)   NATIVESKIP(uv)
